...
experiments = [
    ...
    },
    {
        ...
        "rationale": "Directly answers a reviewer ('do you even need SAEs?'). Either outcome strengthens the paper: raw-probe agreement shows H1 is method-robust; SAE advantage shows SAE-specific value. Pilot already shows SAE >= raw on strand/burial AUROC.",
    ...
    },
    {
        ...
        "rationale": "Moves the paper from correlation to causation (a reviewer's top request) and isolates the features that actually matter, addressing the user's priority that analysis should focus on causal features.",
    ...
    },
    {
        ...
        "rationale": "Answers a reviewer ('how big is the effect?') by providing the missing lower bound. Pilot: real mean +0.054 vs global-shuffle +0.0007 (~74x), confirming the metric tracks genuine 3D contacts.",
    ...
    },
    {
        ...
        "rationale": "a reviewer's request; makes the biology legible and complements quantitative results with intuition.",
